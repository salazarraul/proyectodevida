...
function LlenarCarrito(){
    ...
    document.getElementById("TotalPedido").innerHTML = "Total de Compras: "+total;
}
...
// funcion para sumar los precios de los productos
function sumar(i){
...
// Fuuncion para restar los precios de los productos
function restar(i){
